...
# Menggunakan path absolut agar SQLite berjalan stabil di server Render
basedir = os.path.abspath(os.path.dirname(__file__))
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'chat_pro.db')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

db = SQLAlchemy(app)
# Mengatur cors_allowed_origins agar SocketIO bisa diakses dari domain publik Render
